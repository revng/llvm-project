...
// Wrapper for ElementsAreArray that works with ranges lacking ::value_type
// (e.g., iterator_range).
template <typename Range> auto RangeElementsAre(const Range &R) {
  return ElementsAreArray(adl_begin(R), adl_end(R));
}
...
TYPED_TEST(RadixTreeTypeTest, InsertOne) {
  ...
  EXPECT_TRUE(IsNew);
  const auto &[K, V] = *It;
  EXPECT_THAT(K, RangeElementsAre(this->make1(1)));
  EXPECT_EQ(4, V);

  EXPECT_THAT(T, ElementsAre(Pair(RangeElementsAre(this->make1(1)), 4)));

  EXPECT_THAT(T.find_prefixes(this->make1(1)),
              ElementsAre(Pair(RangeElementsAre(this->make1(1)), 4)));
...
TYPED_TEST(RadixTreeTypeTest, InsertSuperStrings) {
  ...
  EXPECT_THAT(T,
              UnorderedElementsAre(Pair(RangeElementsAre(this->make1(0)), 0),
                                   Pair(RangeElementsAre(this->make1(2)), 2),
                                   Pair(RangeElementsAre(this->make1(4)), 4),
                                   Pair(RangeElementsAre(this->make1(6)), 6)));
...
TYPED_TEST(RadixTreeTypeTest, InsertSubStrings) {
  ...
  EXPECT_THAT(T,
              UnorderedElementsAre(Pair(RangeElementsAre(this->make1(1)), 1),
                                   Pair(RangeElementsAre(this->make1(3)), 3),
                                   Pair(RangeElementsAre(this->make1(5)), 5),
                                   Pair(RangeElementsAre(this->make1(7)), 7)));
...
TYPED_TEST(RadixTreeTypeTest, InsertVShape) {
  ...
  EXPECT_THAT(T,
              UnorderedElementsAre(Pair(RangeElementsAre(this->make1(5)), 15),
                                   Pair(RangeElementsAre(this->make2(6)), 26),
                                   Pair(RangeElementsAre(this->make2(1)), 21)));

  EXPECT_THAT(T.find_prefixes(this->make1(7)),
              UnorderedElementsAre(Pair(RangeElementsAre(this->make2(1)), 21),
                                   Pair(RangeElementsAre(this->make1(5)), 15)));
