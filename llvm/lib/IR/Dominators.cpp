...
template void llvm::DomTreeBuilder::ApplyUpdates<BasicBlock, false, DTIdentityView>(
    DomTreeBuilder::BBDomTree &DT, DomTreeBuilder::BBUpdates);
template void llvm::DomTreeBuilder::ApplyUpdates<BasicBlock, true, DTIdentityView>(
